...
SYSLIBS=$(MTOOLKITSRC)/libXt.a $(XLIBSRC)/libX11.a
 ...
 EXTRA_LOAD_FLAGS =
  EXTRA_LIBRARIES =
    ...
    INSTKMEMFLAGS = -m 4755
          ...
          DESTDIR = /stg3/X.V11R4/sparc

     TOP_INCLUDES = -I$(INCROOT)

      CDEBUGFLAGS = -O
        CCOPTIONS = -D_NO_PROTO -DSTRINGS_ALIGNED -DNO_REGEX -DNO_ISDIR -DUSE_RE_COMP -DUSE_GETWD
      COMPATFLAGS =
...
# $XConsortium: Project.tmpl,v 1.63 89/12/18 16:46:44 jim Exp $
          ...
          PATHSEP = /
        USRLIBDIR = /stg3/X.V11R4/sparc/lib
           BINDIR = $(DESTDIR)/bin
    ...
    MANSOURCEPATH = $(MANPATH)/man
     ...
     INSTAPPFLAGS = $(INSTDATFLAGS)
	   ...
	   X11TOP = /stg3/X.V11R4.comp/mit
	   X11LIB = /stg3/X.V11R4/sparc
        CONFIGSRC = $(TOP)/config
        CLIENTSRC = $(TOP)/clients
          DEMOSRC = $(TOP)/demos
           LIBSRC = $(TOP)/lib
          FONTSRC = $(X11TOP)/fonts
       INCLUDESRC = $(TOP)/X11
        SERVERSRC = $(TOP)/server
          UTILSRC = $(TOP)/util
        SCRIPTSRC = $(UTILSRC)/scripts
       EXAMPLESRC = $(X11TOP)/examples
       CONTRIBSRC = $(TOP)/../contrib
           DOCSRC = $(TOP)/doc
           RGBSRC = $(TOP)/rgb
        DEPENDSRC = $(UTILSRC)/makedepend
         IMAKESRC = $(CONFIGSRC)
         XAUTHSRC = $(X11TOP)/lib/Xau
          XLIBSRC = $(X11TOP)/lib/X
           XMUSRC = $(X11TOP)/lib/Xmu
       TOOLKITSRC = $(X11TOP)/lib/Xt
       AWIDGETSRC = $(X11TOP)/lib/Xaw
       OLDXLIBSRC = $(LIBSRC)/oldX
      XDMCPLIBSRC = $(X11TOP)/lib/Xdmcp
      BDFTOSNFSRC = $(FONTSRC)/bdftosnf
     MKFONTDIRSRC = $(FONTSRC)/mkfontdir
     EXTENSIONSRC = $(X11TOP)/extensions
 ...
 LINTEXTENSIONLIB = $(USRLIBDIR)/llib-lXext.ln
      ...
      USRINCDIR = $(DESTDIR)/include
        TESTSRC = $(TOP)/tests
    MTOOLKITSRC = $(X11TOP)/lib/Xt
...
install:: xfishtank
	$(INSTALL) -c $(INSTPGMFLAGS)   xfishtank $(BINDIR)

install.man:: xfishtank.man
	$(INSTALL) -c $(INSTMANFLAGS) xfishtank.man $(MANDIR)/xfishtank.n
